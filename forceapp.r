...
combinedPPPRadarsUI <- function(id) {
  ...
  fluidPage(
    ...
    "))
      ...
      /* Main title styling - Premier branded header */
      .main-title {
        background: linear-gradient(135deg, #FFD700 0%, #FFC700 100%);
        text-align: center;
        padding: 20px;
      ...
      /* Professional variable selector */
      ...
      .variable-selector-box:hover {
        border-color: #FFD700;
      }
      
      /* Custom scrollbar */
      .variable-selector-box::-webkit-scrollbar {
        width: 8px;
      }
      
      .variable-selector-box::-webkit-scrollbar-track {
        background: #f1f1f1;
        border-radius: 4px;
      }
      
      .variable-selector-box::-webkit-scrollbar-thumb {
        background: #888;
        border-radius: 4px;
      }
      
      .variable-selector-box::-webkit-scrollbar-thumb:hover {
        background: #555;
      }
      ...
      .selection-count-bar.valid {
        background: linear-gradient(90deg, #d4edda 0%, #c3e6cb 100%);
        color: #155724;
        border-color: #c3e6cb;
      }
      
      .selection-count-bar.invalid {
      ...
      /* Athlete selector special styling */
      .athlete-selector {
    ...
    div(
      ...
      img(src = "P3_barbell.jpg", height = "60px", width = "72px")
    ),
    ...
    sidebarLayout(
      sidebarPanel(
        ...
        div(
          ...
          # Athlete selector with special styling
          div(
            class = "athlete-selector",
            tags$label("Select Athlete", `for` = ns("select_athlete")),
            selectInput(ns("select_athlete"), NULL,
          ...
          # Predicted velocity selector
          uiOutput(ns("predicted_velo_selector")),
          
          # Radar Chart Variables section
          div(
            class = "filter-section",
            h4(HTML("Radar Chart Variables"), class = "section-header"),
            p("Select 3-6 metrics to compare performance", class = "info-text"),
            ...
            hr(),
            span("Test Trials", class = "section-subheader"),
            ...
            hr(),
            span("Comparison Overlays", class = "section-subheader"),
            div(style = "padding-left: 12px;",
                checkboxInput(ns("show_avg_all"), "Show Overall Average", value = FALSE)
            ),
            
            hr(),
            span("Velocity Group Filter", class = "section-subheader"),
            selectInput(ns("select_velocity_group"), NULL,
                        choices = c("All Athletes" = "All",
                                    "< 80 mph" = "<80",
                                    "80-85 mph" = "80-85",
                                    "85-90 mph" = "85-90",
                                    "> 90 mph" = ">90"),
          ...
          div(
            class = "filter-section",
            h4("Trend Analysis", class = "section-header"),
            p("Track metric progression over time", class = "info-text"),
            selectInput(ns("trend_metric"), NULL,
                        choices = friendly_choices,
                        selected = default_selected_metrics[1],
                        width = "100%")
          ),
          ...
          div(
            class = "filter-section",
            h4("Performance Metrics Table", class = "section-header"),
            p("Select up to 6 metrics for detailed view", class = "info-text"),
          ...
          downloadButton(ns("downloadPlot"), 
                         HTML("<i class='fa fa-download'></i> DOWNLOAD REPORT"), 
